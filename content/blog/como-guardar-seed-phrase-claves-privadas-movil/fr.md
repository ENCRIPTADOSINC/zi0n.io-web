...
L'une des erreurs les plus fréquentes en matière de cryptomonnaies consiste à enregistrer sa phrase de récupération de 12 ou 24 mots (seed phrase) sur des supports non sécurisés : captures d'écran dans la galerie photo, applications de notes synchronisées dans le cloud ou brouillons de messagerie.
